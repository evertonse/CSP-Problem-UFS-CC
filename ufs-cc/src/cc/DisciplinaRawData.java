...
public class  DisciplinaRawData {
 //Código Componente|Curricular|Tipo|CR|CH Total|CH Teórico|CH Prática Pré-Requisito
	...
	static public String[] getRawLinguagensDeProgramação() {
		return new String[]
		{
	...
	static public String[] getRawComputaçãoTeoricaAlgoritmos() {
		return new String[]
		{
	...
	static public String[] getRawProcessamentoDeImagensComputaçãoGrafica() {
		return new String[]
		{
